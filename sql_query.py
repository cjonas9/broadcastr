...
# This is a very rudimentary function that just takes a userid and chugs through storing all of their
# top tracks and artists. I'm honestly just calling it by putting one line at the end of this
# file and running the file itself. Super hacky but makes the commitments to the DB that we want
#
