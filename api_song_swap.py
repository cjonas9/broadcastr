...
def api_get_song_swaps():
    ...
    Returns JSON:
      {
        "songSwaps": [
          { "id": int, 
            ...
            "initiated_user": str,
            "initiated_user_pfp_sm": str,
            "initiated_user_pfp_med": str,
            "initiated_user_pfp_lg": str,
            "initiated_user_pfp_xl": str,
            "matched_user_id": int,
            "matched_user": str,
            "matched_user_pfp_sm": str,
            "matched_user_pfp_med": str,
            "matched_user_pfp_lg": str,
            "matched_user_pfp_xl": str,
            "initiated_track_id": int,
            "initiated_track_name": str,
            "initiated_track_url": str,
            "initiated_artist_id": int,
            "initiated_artist_name": str,
            "matched_track_id": int,
            "matched_track_name": str,
            "matched_track_url": str,
    ...
    sql = """
        SELECT DISTINCT SongSwap.SongSwapID AS id, 
			...
			InitiatedUser.PfpSmall AS initiated_user_pfp_sm, InitiatedUser.PfpMedium as initiated_user_pfp_med,
			InitiatedUser.PfpLarge AS initiated_user_pfp_lg, InitiatedUser.PfpExtraLarge as initiated_user_pfp_xl,
            MatchedUser.UserID AS matched_user_id, MatchedUser.LastFmProfileName AS matched_user,
			MatchedUser.PfpSmall AS matched_user_pfp_sm, MatchedUser.PfpMedium as matched_user_pfp_med,
			MatchedUser.PfpLarge AS matched_user_pfp_lg, MatchedUser.PfpExtraLarge as matched_user_pfp_xl,
            InitiatedTrack.TrackID AS initiated_track_id, InitiatedTrack.TrackName AS initiated_track_name,
            InitiatedTrack.LastFmTrackUrl AS initiated_track_url,
            ...
            MatchedTrack.LastFmTrackUrl AS matched_track_url,
    ...
    song_swaps = [
        {
            ...
            "initiated_user_pfp_sm":        row["initiated_user_pfp_sm"],
            "initiated_user_pfp_med":       row["initiated_user_pfp_med"],
            "initiated_user_pfp_lg":        row["initiated_user_pfp_lg"],
            "initiated_user_pfp_xl":        row["initiated_user_pfp_xl"],
            "matched_user_id":              row["matched_user_id"],
            "matched_user":                 row["matched_user"],
            "matched_user_pfp_sm":          row["matched_user_pfp_sm"],
            "matched_user_pfp_med":         row["matched_user_pfp_med"],
            "matched_user_pfp_lg":          row["matched_user_pfp_lg"],
            "matched_user_pfp_xl":          row["matched_user_pfp_xl"],
            "initiated_track_id":           row["initiated_track_id"],
            "initiated_track_name":         row["initiated_track_name"],
            "initiated_track_url":          row["initiated_track_url"],
            ...
            "matched_track_url":            row["matched_track_url"],
