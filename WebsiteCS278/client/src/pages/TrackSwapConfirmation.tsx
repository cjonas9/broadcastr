...
export default function TrackSwapConfirmation() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col justify-between p-6">
      ...
      <div className="max-w-md mx-auto w-full flex flex-col items-center mb-8">
        ...
        <Button
          className="w-full text-lg py-6 mt-2 bg-[#7C3AED] hover:bg-[#a78bfa] text-white font-bold border-none"
          onClick={() => setLocation("/track-swap-results")}
        >
          View Swap
        </Button>
        <Button
          className="w-full text-lg py-6 mt-2 bg-gray-700 text-white font-semibold border-none"
          onClick={() => setLocation("/")}
          variant="secondary"
        >
          Back to Home
